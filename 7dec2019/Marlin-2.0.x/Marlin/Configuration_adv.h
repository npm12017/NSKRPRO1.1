 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 60 //40        // Seconds 27/12/2019
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD 20 //20                // Seconds 27/12/2019
 ...
 */
#define E0_AUTO_FAN_PIN PE6 //-1 28/12/2019
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   50  // (mm/s) Slow move when starting load.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     2000  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define ADVANCED_PAUSE_RESUME_PRIME          45  // (mm) Extra distance to prime nozzle after returning from park.
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       815        // (mA) RMS current. Multiply by 1.414 for peak current.
